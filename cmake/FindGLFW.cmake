...
macro(find_glfw)
  ...
  if(NOT GLFW_LIBRARY)
    ...
    # message("GLFW_MODULE_NAME: ${GLFW_MODULE_NAME}") dump(GLFW_FOUND
    # GLFW_LIBRARIES GLFW_LINK_LIBRARIES GLFW_LIBRARY_DIRS GLFW_LDFLAGS
    # GLFW_LDFLAGS_OTHER GLFW_INCLUDE_DIRS GLFW_CFLAGS GLFW_CFLAGS_OTHER)
