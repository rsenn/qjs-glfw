macro(build_glfw)
  ...
  ExternalProject_Add(
    ...
    UPDATE_COMMAND sed -i "s|DEFINE_SYMBOL _GLFW_BUILD_DLL||g" ${CMAKE_CURRENT_SOURCE_DIR}/glfw/src/CMakeLists.txt
    PREFIX glfw
    CMAKE_ARGS -DBUILD_SHARED_LIBS:BOOL=OFF -DENABLE_SHARED:BOOL=OFF "-DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}" "-DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=${CMAKE_POSITION_INDEPENDENT_CODE}"
               "-DCMAKE_C_COMPILER:STRING=${CMAKE_C_COMPILER}" "-DCMAKE_C_FLAGS:STRING=${CMAKE_C_FLAGS} ${MODULE_COMPILE_FLAGS}" -DGLFW_BUILD_DOCS:BOOL=OFF -DGLFW_BUILD_EXAMPLES:BOOL=OFF
