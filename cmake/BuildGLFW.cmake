macro(build_glfw)
  ...
  ExternalProject_Add(
    ...
    PREFIX glfw
    CMAKE_ARGS -DBUILD_SHARED_LIBS:BOOL=OFF -DENABLE_SHARED:BOOL=OFF "-DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}" "-DCMAKE_POSITION_INDEPENDENT_CODE:BOOL=${CMAKE_POSITION_INDEPENDENT_CODE}" "-DCMAKE_C_COMPILER:STRING=${CMAKE_C_COMPILER}"
